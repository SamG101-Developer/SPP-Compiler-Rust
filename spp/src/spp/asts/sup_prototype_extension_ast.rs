...
impl SupPrototypeExtensionAst {
    pub fn new(tok_sup: TokenAst, generic_param_group: Option<GenericParameterGroupAst>, name: TypeAst, tok_ext: TokenAst, superclass: TypeAst, where_block: Option<WhereBlockAst>, body: SupImplementationAst) -> Self {
        Self { tok_sup, generic_param_group, name, tok_ext, superclass, where_block, body, scope_cls: None, _ctx: None }
    }
}
